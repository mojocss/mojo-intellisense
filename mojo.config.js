    ...
    base: {
      ...
      definedValues: {
        ...
        boxShadow: {
          ...
          1: "0 1px 2px var(--m-shadow-color, #0000001a)",
          2: "0 1px 3px var(--m-shadow-color, #0000001a), 0 1px 2px var(--m-shadow-color, #0000001a)",
          3: "0 4px 6px var(--m-shadow-color, #0000001a), 0 2px 4px var(--m-shadow-color, #0000001a)",
          4: "0 10px 15px var(--m-shadow-color, #0000001a), 0 4px 6px var(--m-shadow-color, #0000001a)",
          5: "0 20px 25px var(--m-shadow-color, #0000001a), 0 10px 10px var(--m-shadow-color, #0000001a)",
        },
        animation: {
          spin: {
